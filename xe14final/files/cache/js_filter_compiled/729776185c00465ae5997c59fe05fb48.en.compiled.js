function delete_profile_image(form){ return legacy_filter('delete_profile_image', form, 'member', 'procMemberDeleteProfileImage', filterAlertMessage, [], 'Are you sure to delete?', {}) };
(function($){
