function insert_lang(form){ return legacy_filter('insert_lang', form, 'module', 'procModuleAdminInsertLang', completeInsertLang, ['error','message','name'], 'Are you sure to submit?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_lang", {'lang_code': {required:true,rule:'alpha_number'}}]);
	
	v.cast('ADD_MESSAGE',['lang_code','Language Code']);
