function insert_document_module_config(form){ return legacy_filter('insert_document_module_config', form, 'document', 'procDocumentInsertModuleConfig', filterAlertMessage, ['error','message'], 'Are you sure to submit?', {}) };
(function($){
