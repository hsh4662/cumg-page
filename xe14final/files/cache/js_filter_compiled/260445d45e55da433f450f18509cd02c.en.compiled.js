function insert_grant(form){ return legacy_filter('insert_grant', form, 'module', 'procModuleAdminInsertGrant', completeInsertGrant, ['error','message'], 'Are you sure to submit?', {}) };
(function($){
