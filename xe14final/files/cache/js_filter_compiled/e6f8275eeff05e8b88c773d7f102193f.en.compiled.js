function delete_image_name(form){ return legacy_filter('delete_image_name', form, 'member', 'procMemberDeleteImageName', filterAlertMessage, [], 'Are you sure to delete?', {}) };
(function($){
