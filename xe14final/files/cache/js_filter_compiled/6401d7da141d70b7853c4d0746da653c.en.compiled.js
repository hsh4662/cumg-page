function insert_trackback_module_config(form){ return legacy_filter('insert_trackback_module_config', form, 'trackback', 'procTrackbackAdminInsertModuleConfig', filterAlertMessage, ['error','message'], 'Are you sure to submit?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_trackback_module_config", {}]);
