function delete_image_mark(form){ return legacy_filter('delete_image_mark', form, 'member', 'procMemberDeleteImageMark', filterAlertMessage, [], 'Are you sure to delete?', {}) };
(function($){
