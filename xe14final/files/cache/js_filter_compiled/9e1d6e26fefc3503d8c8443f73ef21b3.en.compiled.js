function insert_point_module_config(form){ return legacy_filter('insert_point_module_config', form, 'point', 'procPointAdminInsertPointModuleConfig', filterAlertMessage, ['error','message'], 'Are you sure to update?', {}) };
(function($){
