function insert_file_module_config(form){ return legacy_filter('insert_file_module_config', form, 'file', 'procFileAdminInsertModuleConfig', filterAlertMessage, ['error','message'], 'Are you sure to submit?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_file_module_config", {}]);
