...
<form method="get" action="./" id="member_fo">
    ...
    <tbody>
        ...
        <tr class="row<?php @print($__Context->cycle_idx);?>">
            ...
            <td class="nowrap">
                <?php  if($__Context->val->homepage){ ?><a href="<?php @print(htmlspecialchars($__Context->val->homepage));?>" class="homepage" onclick="window.open(this.href);return false;"><img src="/xe14final/modules/member/tpl/images/icon_homepage.gif" title="<?php @print($__Context->lang->homepage);?>" alt="<?php @print($__Context->lang->homepage);?>" /></a> <?php  } ?>
                <?php  if($__Context->val->blog){ ?><a href="<?php @print(htmlspecialchars($__Context->val->blog));?>" class="blog" onclick="window.open(this.href);return false;"><img src="/xe14final/modules/member/tpl/images/icon_blog.gif" title="<?php @print($__Context->lang->blog);?>" alt="<?php @print($__Context->lang->blog);?>" /></a> <?php  } ?>&nbsp;
            </td>
            <td><?php  if($__Context->val->is_admin != 'Y'){ ?><a href="<?php @print(getUrl('act','dispMemberAdminDeleteForm','member_srl', $__Context->val->member_srl));?>" title="<?php @print($__Context->lang->cmd_delete);?>" class="buttonSet buttonDelete"><span><?php @print($__Context->lang->cmd_delete);?></span></a><?php  }else{ ?><img src="/xe14final/modules/member/tpl/images/icon_management.gif" title="<?php @print($__Context->lang->is_admin);?>" alt="<?php @print($__Context->lang->is_admin);?>" /><?php  } ?></td>
        </tr>
        <tr>
