...
<tbody>
    <?php $__Context->Context->__idx[1]=0;if(count($__Context->board_list))  foreach($__Context->board_list as $__Context->no => $__Context->val){$__Context->__idx[2]=($__Context->__idx[2]+1)%2; $__Context->cycle_idx = $__Context->__idx[2]+1; ?>
    <tr>
        ...
        <td><a href="<?php @print(getUrl('act','dispBoardAdminBoardInfo','module_srl',$__Context->val->module_srl));?>" class="buttonSet buttonSetting"><span><?php @print($__Context->lang->cmd_setup);?></span></a></td>
        ...
        <td><a href="<?php @print(getUrl('act','dispBoardAdminDeleteBoard','module_srl', $__Context->val->module_srl));?>" class="buttonSet buttonDelete"><span><?php @print($__Context->lang->cmd_delete);?></span></a></td>
    </tr>
    <?php  } ?>
</tbody>
</table>
...
<div class="clear">
    ...
    <div class="fr">
        <a href="<?php @print(getUrl('act','dispBoardAdminInsertBoard','module_srl',''));?>" class="button black strong"><span><?php @print($__Context->lang->cmd_make);?></span></a>
    </div>
</div>
