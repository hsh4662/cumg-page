            ...
            <ul class="type">
                <li class="xpress_xeditor_ui_format">
                    <select class="xpress_xeditor_ui_format_select" disabled="disabled">
                        ...
                        <?php $__Context->Context->__idx[4]=0;if(count($__Context->lang->edit->header_list))  foreach($__Context->lang->edit->header_list as $__Context->key=>$__Context->obj){$__Context->__idx[5]=($__Context->__idx[5]+1)%2; $__Context->cycle_idx = $__Context->__idx[5]+1; ?>
                ...
                <li class="xpress_xeditor_ui_fontName">
                    <select class="xpress_xeditor_ui_fontName_select" disabled="disabled">
                        ...
                        <?php $__Context->Context->__idx[5]=0;if(count($__Context->lang->edit->fontlist))  foreach($__Context->lang->edit->fontlist as $__Context->key=>$__Context->obj){$__Context->__idx[6]=($__Context->__idx[6]+1)%2; $__Context->cycle_idx = $__Context->__idx[6]+1; ?>
                ...
                <li class="extensions xpress_xeditor_ui_extension">
                    ...
                    <div class="layer extension2 xpress_xeditor_extension_layer" id="editorExtension_<?php @print($__Context->editor_sequence);?>">
                        <ul id="editor_component_<?php @print($__Context->editor_sequence);?>" class="editorComponent">
                            <?php $__Context->Context->__idx[6]=0;if(count($__Context->component_list))  foreach($__Context->component_list as $__Context->component_name => $__Context->component){$__Context->__idx[7]=($__Context->__idx[7]+1)%2; $__Context->cycle_idx = $__Context->__idx[7]+1; ?>
                                <li><?php  if($__Context->component->component_icon){ ?><img src="/~cumg/xe14final/modules/editor/components/<?php @print($__Context->component_name);?>/component_icon.gif" alt="" width="13" height="12"/> <?php  } ?><a href="#" onclick="return false;" id="component_<?php @print($__Context->editor_sequence);?>_<?php @print($__Context->component_name);?>"><?php @print($__Context->component->title);?></a></li>
                            <?php  } ?>
                        </ul>
                    </div>
                </li>
