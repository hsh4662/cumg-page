...
<div class="content">
	...
	<div class="section">
		...
		<div class="dashboardWire">
			<dl class="legend">
				<dt class="past"><img src="/~cumg/xe14final/common/tpl/images/blank.gif" width="5" height="5" alt="<?php @print($__Context->lang->yesterday);?>" /></dt>
				<dd><?php @print($__Context->lang->last_week);?></dd>
				<dt class="today"><img src="/~cumg/xe14final/common/tpl/images/blank.gif" width="5" height="5" alt="<?php @print($__Context->lang->today);?>" /></dt>
