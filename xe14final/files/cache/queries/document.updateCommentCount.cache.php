...
$output->query_id = "document.updateCommentCount";
...
$output->columns = array ( array("name"=>"comment_count","alias"=>"","value"=>$args->comment_count),
array("name"=>"update_order","alias"=>"","value"=>$args->update_order),
array("name"=>"last_update","alias"=>"","value"=>$args->last_update?$args->last_update:date("YmdHis")),
array("name"=>"last_updater","alias"=>"","value"=>$args->last_updater),
 );
